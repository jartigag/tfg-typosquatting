...
# usage: bash split-typoDict.sh compact-typoDict.json
...
do
	...
	#WIP: all domains in same file ($custCode-typoDict.json)
	...
	then
		...
		# new custCode
		truncate -s-2 typoDicts/$lastCustCode-typoDict.json # remove last ",\n"
